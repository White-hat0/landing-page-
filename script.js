...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // إظهار جميع الألعاب عند تحميل الصفحة
  if (allCardsContainer) allCardsContainer.style.display = 'flex';
  if (searchCardsContainer) searchCardsContainer.style.display = 'none';
